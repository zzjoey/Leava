...
var resig = function(tar,data){
    ...
    app.coolsite360._coolsite.register(_tar);
    play(data);
}
...
var _doTranslate = function(opt){ 
    ...
    _style.opacity = 1;
    getApp().coolsite360.$(el).addStyle(_style);
}
//初始化动画
...
var _preAni = function(opt,detail){
    ...
    var opa_ani = animation.opacity(_op).scale(_sc).step().export();
    getApp().coolsite360.$(el).setAnimation(opa_ani)
}
